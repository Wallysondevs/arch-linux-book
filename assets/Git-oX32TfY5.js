import{j as t}from"./ui-K-J8Jkwj.js";import{P as e}from"./PageContainer-tnnsMrcC.js";import{C as i}from"./CodeBlock-DEDRw1y6.js";import"./router-CFQymoZQ.js";import"./index-De_u_y1v.js";import"./vendor-bfizL-CB.js";import"./syntax-C0AEetN3.js";function m(){return t.jsxs(e,{title:"Git no Arch Linux",subtitle:"Controle de versão essencial para todo desenvolvedor. Do básico ao avançado — branching, rebasing, hooks, worktrees e integração com GitHub/GitLab.",difficulty:"iniciante",timeToRead:"20 min",children:[t.jsx("h2",{children:"Instalação e Configuração Inicial"}),t.jsx(i,{title:"Instalar e configurar Git",code:`# Instalar Git
sudo pacman -S git
...
git config --list
cat ~/.gitconfig`}),t.jsx("h2",{children:"Comandos Essenciais"}),t.jsx(i,{title:"Fluxo básico do Git",code:`# Iniciar repositório
git init
...
git log --since="1 week ago"`}),t.jsx("h2",{children:"Branches"}),t.jsx(i,{title:"Trabalhar com branches",code:`# Listar branches
git branch           # Locais
...
git branch -m nome-novo               # Renomear a atual`}),t.jsx("h2",{children:"Merge e Rebase"}),t.jsx(i,{title:"Integrar mudanças",code:`# Merge (cria commit de merge)
git checkout main
...
git add .
git rebase --continue
git merge --continue`}),t.jsx("h2",{children:"Repositórios Remotos"}),t.jsx(i,{title:"Trabalhar com remotos",code:`# Listar remotos
git remote -v
...
git push origin --delete feature  # Deletar branch remota`}),t.jsx("h2",{children:"Stash"}),t.jsx(i,{title:"Guardar mudanças temporariamente",code:`# Guardar mudanças no stash
git stash
...
git stash clear    # Deletar todos`}),t.jsx("h2",{children:"Autenticação com GitHub via SSH"}),t.jsx(i,{title:"Configurar SSH para GitHub/GitLab",code:`# Gerar chave SSH
...
# Usar:
git remote set-url origin git@github-pessoal:user/repo.git`}),t.jsx("h2",{children:"Git Hooks"}),t.jsx(i,{title:"Automatizar com hooks",code:`# Hooks ficam em .git/hooks/
ls .git/hooks/
...
sudo pacman -S lefthook  # ou via npm: npm install --save-dev husky`}),t.jsx("h2",{children:"Git Avançado"}),t.jsx(i,{title:"Comandos avançados",code:`# Cherry-pick (aplicar commit específico)
...
git blame -L 10,20 arquivo.py  # Apenas linhas 10-20`})]})}export{m as default};
