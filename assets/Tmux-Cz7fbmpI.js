import{j as e}from"./ui-K-J8Jkwj.js";import{P as i}from"./PageContainer-tnnsMrcC.js";import{C as a}from"./CodeBlock-DEDRw1y6.js";import"./router-CFQymoZQ.js";import"./index-De_u_y1v.js";import"./vendor-bfizL-CB.js";import"./syntax-C0AEetN3.js";function c(){return e.jsxs(i,{title:"tmux - Multiplexador de Terminal",subtitle:"Múltiplas janelas, painéis e sessões persistentes em um único terminal. O tmux é essencial para produtividade máxima no terminal e trabalho remoto.",difficulty:"intermediario",timeToRead:"20 min",children:[e.jsx("h2",{children:"Por que usar tmux?"}),e.jsx("p",{children:"O tmux (terminal multiplexer) permite que você:"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"Sessões persistentes"})," — Processos continuam rodando mesmo se a conexão SSH cair"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Múltiplos painéis"})," — Dividir o terminal em múltiplas áreas horizontais/verticais"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Múltiplas janelas"})," — Abas dentro de uma sessão tmux"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Detach/Attach"})," — Desconectar de uma sessão e reconectar mais tarde"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Compartilhar sessões"})," — Múltiplos usuários vendo o mesmo terminal"]})]}),e.jsx("h2",{children:"Instalação"}),e.jsx(a,{title:"Instalar tmux",code:`sudo pacman -S tmux

# Verificar versão
tmux -V`}),e.jsx("h2",{children:"Conceitos Fundamentais"}),e.jsxs("p",{children:["O tmux tem uma hierarquia: ",e.jsx("strong",{children:"Servidor → Sessão → Janela → Painel"})]}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"Servidor"})," — Processo tmux em background que gerencia tudo"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Sessão"})," — Conjunto de janelas. Pode ser nomeada. Persiste após desconexão."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Janela"}),' — Uma "aba" dentro de uma sessão. Cada janela tem um ou mais painéis.']}),e.jsxs("li",{children:[e.jsx("strong",{children:"Painel"})," — Uma divisão da tela dentro de uma janela."]})]}),e.jsxs("p",{children:["O ",e.jsx("strong",{children:"prefixo"})," é a combinação de teclas que precede todos os atalhos do tmux. O padrão é ",e.jsx("code",{children:"Ctrl+b"}),". Neste guia, usamos a notação ",e.jsx("code",{children:"Prefix"})," para isso."]}),e.jsx("h2",{children:"Sessões"}),e.jsx(a,{title:"Gerenciar sessões",code:`# Criar nova sessão
tmux
...
tmux kill-server                # Matar TODOS os servidores tmux`}),e.jsx("h2",{children:"Janelas"}),e.jsx(a,{title:"Gerenciar janelas (tabs)",code:`# Dentro de uma sessão tmux:
...
# Prefix + f       = Buscar janela por nome`}),e.jsx("h2",{children:"Painéis (Panes)"}),e.jsx(a,{title:"Dividir e navegar entre painéis",code:`# Dividir painéis:
...
# Prefix + !       = Converter painel em janela separada`}),e.jsx("h2",{children:"Configuração: ~/.tmux.conf"}),e.jsx(a,{title:"Configuração básica do tmux",code:`# Mudar prefixo para Ctrl+a (mais ergonômico para muitos)
unbind C-b
set -g prefix C-a
...
set -g status-interval 5`}),e.jsx("h2",{children:"Modo de Cópia (Copy Mode)"}),e.jsx(a,{title:"Selecionar e copiar texto",code:`# Entrar em modo de cópia
...
# Para Wayland:
bind -T copy-mode-vi y send -X copy-pipe "wl-copy"`}),e.jsx("h2",{children:"Plugins com TPM"}),e.jsx(a,{title:"tmux Plugin Manager (TPM)",code:`# Instalar TPM
...
# Remover plugins não listados: Prefix + Alt + u`}),e.jsx("h2",{children:"Comandos Úteis para SSH"}),e.jsx(a,{title:"tmux com SSH",code:`# Conectar via SSH e criar/reconectar sessão tmux
...
# Reconectar depois:
ssh usuario@servidor
tmux a -t backup`})]})}export{c as default};
