import{j as e}from"./ui-K-J8Jkwj.js";import{P as r}from"./PageContainer-tnnsMrcC.js";import{C as o}from"./CodeBlock-DEDRw1y6.js";import{A as a}from"./AlertBox-D1nNvzza.js";import"./router-CFQymoZQ.js";import"./index-De_u_y1v.js";import"./vendor-bfizL-CB.js";import"./syntax-C0AEetN3.js";function l(){return e.jsxs(r,{title:"Docker & Podman no Arch",subtitle:"Containers no Arch Linux — instale Docker e Podman, crie imagens, gerencie redes e volumes, use Docker Compose e entenda a diferença entre os dois engines.",difficulty:"intermediario",timeToRead:"20 min",children:[e.jsx("h2",{children:"Docker vs Podman"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"Docker"})," — O mais popular. Usa daemon (dockerd) rodando como root. Excelente ecosystem e documentação."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Podman"})," — Daemonless, rootless por padrão. Compatível com Docker CLI. Melhor segurança. Da Red Hat."]})]}),e.jsx("h2",{children:"Instalando Docker"}),e.jsx(o,{title:"Instalar e configurar Docker",code:`# Instalar Docker e plugins
...
docker run hello-world`}),e.jsx("h2",{children:"Comandos Essenciais Docker"}),e.jsx(o,{title:"Gerenciar containers",code:`# === Containers ===
...
docker rm -f meu-nginx       # Remove forçado (mesmo rodando)`}),e.jsx("h2",{children:"Dockerfile"}),e.jsx(o,{title:"Criar imagem personalizada",code:`# Dockerfile para app Python/FastAPI
cat > Dockerfile << 'EOF'
# Imagem base
...
# Rodar a imagem
docker run -d -p 8000:8000 --name api minha-api:latest`}),e.jsx("h2",{children:"Docker Compose"}),e.jsx(o,{title:"docker-compose.yml - Orquestrar múltiplos containers",code:`# docker-compose.yml
version: '3.9'
...
volumes:
  postgres_data:`}),e.jsx(o,{title:"Comandos Docker Compose",code:`# Iniciar todos os serviços
docker compose up
...
docker compose exec db psql -U user -d mydb`}),e.jsx("h2",{children:"Podman - A Alternativa Rootless"}),e.jsx(o,{title:"Instalar e usar Podman",code:`# Instalar Podman
...
podman run -d --network minha-rede --name db postgres:16-alpine`}),e.jsx("h2",{children:"Volumes e Redes"}),e.jsx(o,{title:"Gerenciar volumes e redes Docker",code:`# === Volumes ===
...
# psql -h db -U user meudb`}),e.jsxs(a,{type:"info",title:"Limpeza do sistema",children:["Docker pode usar muito espaço. Para limpar tudo não usado:",e.jsx("code",{children:"docker system prune -a --volumes"})," — remove todos os containers parados, imagens não usadas e volumes órfãos. Use com cuidado!"]})]})}export{l as default};
