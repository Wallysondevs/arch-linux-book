import{j as e}from"./ui-K-J8Jkwj.js";import{P as a}from"./PageContainer-tnnsMrcC.js";import{C as o}from"./CodeBlock-DEDRw1y6.js";import{A as r}from"./AlertBox-D1nNvzza.js";import"./router-CFQymoZQ.js";import"./index-De_u_y1v.js";import"./vendor-bfizL-CB.js";import"./syntax-C0AEetN3.js";function u(){return e.jsxs(a,{title:"VPN no Arch Linux",subtitle:"WireGuard, OpenVPN e VPNs comerciais. Configure sua própria VPN segura ou conecte a provedores comerciais para proteger sua privacidade e acessar redes remotas.",difficulty:"avancado",timeToRead:"18 min",children:[e.jsx("h2",{children:"WireGuard - VPN Moderna e Rápida"}),e.jsx("p",{children:"O WireGuard é um protocolo VPN moderno integrado ao kernel Linux (desde 5.6). É muito mais simples de configurar que o OpenVPN, mais rápido e com criptografia moderna."}),e.jsx(o,{title:"Instalar e configurar WireGuard",code:`# WireGuard está integrado ao kernel linux no Arch
...
# Ou usar wg-quick (mais fácil)`}),e.jsx("h2",{children:"WireGuard com wg-quick"}),e.jsx("h3",{children:"Configuração do Servidor"}),e.jsx(o,{title:"/etc/wireguard/wg0.conf - Servidor",code:`[Interface]
...
AllowedIPs = 10.0.0.3/32`}),e.jsx(o,{title:"Ativar servidor WireGuard",code:`# Habilitar IP forwarding no servidor
...
# Ver status
sudo wg show`}),e.jsx("h3",{children:"Configuração do Cliente"}),e.jsx(o,{title:"/etc/wireguard/wg0.conf - Cliente",code:`[Interface]
...
PersistentKeepalive = 25`}),e.jsx(o,{title:"Conectar ao servidor WireGuard",code:`# Conectar
sudo wg-quick up wg0
...
sudo systemctl enable wg-quick@wg0`}),e.jsx("h2",{children:"OpenVPN"}),e.jsx(o,{title:"Instalar e usar OpenVPN",code:`# Instalar OpenVPN
...
# Importar .ovpn via: nm-connection-editor ou interface do NM`}),e.jsx("h2",{children:"VPNs Comerciais"}),e.jsx(o,{title:"Provedores VPN populares no Arch",code:`# Mullvad VPN (foco em privacidade, usa WireGuard)
...
# ou usar site: browserleaks.com`}),e.jsx("h2",{children:"NetworkManager e VPN"}),e.jsx(o,{title:"Gerenciar VPNs via NetworkManager",code:`# Instalar plugins VPN para NM
...
# Clique no ícone de rede → VPN → Conectar`}),e.jsxs(r,{type:"info",title:"Kill Switch",children:['Para máxima privacidade, configure um "kill switch" que bloqueia todo tráfego de internet se a VPN cair. Com o WireGuard, use a opção ',e.jsx("code",{children:"AllowedIPs = 0.0.0.0/0"}),"combinada com regras de firewall que bloqueiam tráfego fora do túnel WireGuard."]})]})}export{u as default};
