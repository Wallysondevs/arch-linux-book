import{j as e}from"./ui-K-J8Jkwj.js";import{P as r}from"./PageContainer-tnnsMrcC.js";import{C as o}from"./CodeBlock-DEDRw1y6.js";import{A as s}from"./AlertBox-D1nNvzza.js";import"./router-CFQymoZQ.js";import"./index-De_u_y1v.js";import"./vendor-bfizL-CB.js";import"./syntax-C0AEetN3.js";function c(){return e.jsxs(r,{title:"Módulos do Kernel",subtitle:"Entenda como drivers e extensões são carregados no kernel do Linux. Gerencie módulos, resolva conflitos e configure carregamento automático.",difficulty:"intermediario",timeToRead:"15 min",children:[e.jsx("h2",{children:"O que são Módulos?"}),e.jsx("p",{children:"Módulos do kernel são partes de código que podem ser carregadas e descarregadas dinamicamente no kernel em execução, sem necessidade de reinicializar o sistema. São usados principalmente para implementar drivers de dispositivos."}),e.jsx("p",{children:"Antes dos módulos, todo driver precisava ser compilado dentro do kernel (monolítico puro). Com módulos, o kernel base fica menor e drivers são carregados conforme necessário."}),e.jsx("h2",{children:"Comandos Básicos"}),e.jsx(o,{title:"Gerenciamento de módulos",code:`# Listar todos os módulos carregados
lsmod
...
sudo rmmod nome_do_modulo         # Remove apenas o módulo específico`}),e.jsx("h2",{children:"Onde Ficam os Módulos"}),e.jsx(o,{title:"Localização dos módulos",code:`# Módulos ficam em:
...
ls /lib/modules/$(uname -r)/kernel/drivers/net/wireless/`}),e.jsx("h2",{children:"Carregamento Automático de Módulos"}),e.jsxs("p",{children:["O ",e.jsx("code",{children:"udev"})," detecta hardware e carrega módulos automaticamente. Mas às vezes você precisa forçar o carregamento de um módulo específico na inicialização."]}),e.jsx(o,{title:"Configurar carregamento automático",code:`# Adicionar módulo para carregar na inicialização
...
ls /etc/modprobe.d/
cat /etc/modprobe.d/*.conf`}),e.jsx("h2",{children:"Bloqueando Módulos (Blacklist)"}),e.jsx("p",{children:"Às vezes você quer impedir que um módulo seja carregado automaticamente — por exemplo, quando há conflito entre dois drivers."}),e.jsx(o,{title:"Bloquear módulos com blacklist",code:`# Criar arquivo de blacklist
...
sudo mkinitcpio -P`}),e.jsxs(s,{type:"warning",title:"Regenerar initramfs",children:["Após modificar ",e.jsx("code",{children:"/etc/modprobe.d/"})," ou ",e.jsx("code",{children:"/etc/modules-load.d/"}),", regenere o initramfs com ",e.jsx("code",{children:"sudo mkinitcpio -P"})," para que as mudanças sejam efetivas desde o início do boot."]}),e.jsx("h2",{children:"Parâmetros de Módulos"}),e.jsx(o,{title:"Configurar parâmetros de módulos",code:`# Ver parâmetros disponíveis de um módulo
...
sudo modprobe iwlwifi 11n_disable=1  # Recarregar com parâmetro`}),e.jsx("h2",{children:"Módulos do Kernel vs Módulos DKMS"}),e.jsx("p",{children:"Existem dois tipos de módulos:"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"In-tree modules"})," — Fazem parte do kernel, sempre compatíveis, ficam em ",e.jsx("code",{children:"/lib/modules/"}),"."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Out-of-tree modules (DKMS)"})," — Desenvolvidos fora do kernel, precisam ser recompilados para cada versão. Ex: driver NVIDIA proprietário, ZFS, VirtualBox."]})]}),e.jsx(o,{title:"Trabalhar com DKMS",code:`# Instalar DKMS
sudo pacman -S dkms
...
# Remover módulo DKMS
dkms remove nome_modulo/versao --all`}),e.jsx("h2",{children:"Diagnóstico de Problemas"}),e.jsx(o,{title:"Diagnosticar problemas com módulos",code:`# Ver todos os eventos de hardware detectados pelo udev
udevadm monitor
...
modprobe --show-depends nome_modulo`}),e.jsx("h2",{children:"Casos Práticos"}),e.jsx("h3",{children:"Driver de Rede sem Fio"}),e.jsx(o,{title:"Diagnosticar driver WiFi",code:`# Ver interface de rede e seu módulo
...
# Instalar firmware
sudo pacman -S linux-firmware`}),e.jsx("h3",{children:"Módulos de Sistema de Arquivos"}),e.jsx(o,{title:"Módulos de sistemas de arquivos",code:`# Ver sistemas de arquivos suportados
...
sudo mount -t ntfs3 /dev/sdb1 /mnt/windows`})]})}export{c as default};
