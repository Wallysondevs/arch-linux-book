import{j as e}from"./ui-K-J8Jkwj.js";import{P as a}from"./PageContainer-tnnsMrcC.js";import{C as s}from"./CodeBlock-DEDRw1y6.js";import{A as o}from"./AlertBox-D1nNvzza.js";import"./router-CFQymoZQ.js";import"./index-De_u_y1v.js";import"./vendor-bfizL-CB.js";import"./syntax-C0AEetN3.js";function p(){return e.jsxs(a,{title:"Hardening do Sistema",subtitle:"Fortaleça a segurança do seu Arch Linux. Reduza a superfície de ataque, configure auditoria, aplique políticas de senha e siga as melhores práticas de segurança.",difficulty:"avancado",timeToRead:"25 min",children:[e.jsx("h2",{children:"Princípios de Hardening"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"Princípio do menor privilégio"})," — Usuários e processos têm apenas as permissões que precisam"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Reduzir superfície de ataque"})," — Desabilitar serviços desnecessários"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Defesa em profundidade"})," — Múltiplas camadas de segurança"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Auditoria"})," — Registrar e monitorar eventos de segurança"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Atualizações"})," — Manter sistema sempre atualizado"]})]}),e.jsx("h2",{children:"Configurações do Kernel (sysctl)"}),e.jsx(s,{title:"/etc/sysctl.d/99-hardening.conf",code:`# Criar arquivo de hardening
...
sudo sysctl --system`}),e.jsx("h2",{children:"Segurança de SSH"}),e.jsx(s,{title:"Hardening do servidor SSH",code:`sudo nano /etc/ssh/sshd_config
...
# Reiniciar SSH
sudo systemctl restart sshd`}),e.jsx("h2",{children:"Firewall Básico"}),e.jsx(s,{title:"Configurar firewall com nftables",code:`# /etc/nftables.conf mínimo e seguro
flush ruleset
...
sudo systemctl enable nftables`}),e.jsx("h2",{children:"Permissões e Arquivos Críticos"}),e.jsx(s,{title:"Verificar e corrigir permissões",code:`# Verificar arquivos SUID (executam como root)
...
chmod 644 ~/.ssh/id_ed25519.pub`}),e.jsx("h2",{children:"Auditoria com auditd"}),e.jsx(s,{title:"Configurar auditoria do sistema",code:`# Instalar auditd
sudo pacman -S audit
...
-a always,exit -F arch=b64 -S execve -F euid=0 -k root_commands`}),e.jsx("h2",{children:"Atualizações Automáticas de Segurança"}),e.jsx(s,{title:"Manter o sistema atualizado",code:`# Atualizar o sistema regularmente
sudo pacman -Syu
...
sudo systemctl enable --now weekly-update.timer`}),e.jsx(o,{type:"info",title:"Hardening não é absoluto",children:"Segurança é um processo contínuo, não um estado final. Hardening reduz o risco mas não o elimina completamente. Combine com: backups regulares, monitoramento, atualizações frequentes e educação sobre engenharia social."})]})}export{p as default};
